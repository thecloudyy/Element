...
public partial class SourceRowViewModel : ObservableObject
{
    ...
    /// <summary>Set the "used/limit" badge plus its green → yellow → red heat.</summary>
...
public partial class DownloadViewModel : ObservableObject
{
    ...
    /// <summary>Plugin picked a source by name. Download+install it headlessly.</summary>
    ...
    private async Task FetchAsync()
    {
        ...
        try
        {
            if (Details.IsDlc)
            {
                ...
                // DLC info is no longer available from the API
                Error = "DLC information is no longer available";
            }
            else
            {
