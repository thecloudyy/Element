...
/// </summary>
/// <remarks>
/// This body previously existed twice, byte for byte: <c>ElementApiClient.SaveResponseAsync</c> and
/// <c>ElementApiClient.SaveResponseAsync</c>, each with its own private copy of the staging path constant.
...
internal static class HttpFileDownloader
{
    ...
    public static readonly string StagingFolder =
        Path.Combine(Path.GetTempPath(), "ElementGui", "downloads");
