...
public class CefInjectorService : IHostedService
{
    ...
    private string? FindLuaToolsJs()
    {
        ...
        // GitHub releases into %AppData%\ElementGui\plugin. If it isn't installed yet, nothing injects.
        string[] candidates =
        {
            Path.Combine(appData, "ElementGui", "plugin", "public", "luatools.js"),
            Path.Combine(appData, "ElementGui", "plugin", "luatools.js"),
        };
