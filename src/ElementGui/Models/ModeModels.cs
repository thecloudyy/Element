...
///
/// The member names are what land in the settings file. Old values ("SteamTools", "OpenSteamTools",
/// "OpenSteamToolsNightly", "CloudRedirect", "Ost", "Bst") are migrated by <see cref="Services.ModeMigration"/>.
/// </summary>
public enum UnlockerMode
{
    Element, // Element: the C++ hook built from tools/Element (madoiscool/Element)
